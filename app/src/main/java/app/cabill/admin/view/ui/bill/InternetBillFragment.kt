...
class InternetBillFragment : Fragment() {
    ...
    private lateinit var adapater: BillAdapter<InternetBill>
    private val list = ArrayList<InternetBill>()
    ...
    override fun onCreateView(
        ...
        binding.complaints.apply {
            adapter = this@InternetBillFragment.adapater
        }
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment InternetBillFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InternetBillFragment().apply {
